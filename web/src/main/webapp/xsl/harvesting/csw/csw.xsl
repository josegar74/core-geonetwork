...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="editPanel-CSW">
		<div id="csw.editPanel">
			...
			<div class="dots"/>
			<xsl:call-template name="owner-CSW"/>
            <div class="dots"/>
	...
	<xsl:template name="owner-CSW">
		...
		<table>
			<tr>
				...
				<td class="padded"><select id="csw.owner" class="content"  onchange="harvesting.csw.loadUserGroups()" /></td>
			</tr>
			...
			<tr>
				...
				<td class="padded">
                    <input type="hidden" id="csw.ownergroup" value="" />
                    <select id="csw.ownergroup_sel" class="content" onchange="harvesting.csw.updateUserGroupSelection()" />
                    <img id="csw.loading_groups" style="display: none" src="{/root/gui/url}/images/loading.gif" width="20" height="21"/>
                </td>
			</tr>
		</table>
	</xsl:template>
